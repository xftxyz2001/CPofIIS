...
BOXES_SAVE_PATH = ROOT_PATH + '/tools/Boxes'
...
PRETRAINED_CKPT = '/home/lihansheng/myResearch/MANY_FPN/data/pretrained_weights/' + NET_NAME + '.ckpt'
TRAINED_CKPT = os.path.join(ROOT_PATH, 'output/trained_weights')
EVALUATE_DIR = ROOT_PATH + '/output/evaluate_result_pickle/'
DATA_DIR='/media/lihansheng/5603d8f3-704d-4241-903d-fa30f6c8f69c/ICPR_detect/miccai/fulldata/folder1/tfrecord'
# ------------------------------------------ Train config
...
DECAY_STEP = [5000, 7500]  # 50000, 70000
MAX_ITERATION = 10000

# -------------------------------------------- Data_preprocess_config
DATASET_NAME = 'icpr2014'  # 'ship', 'spacenet', 'pascal', 'coco','CXR'
...
# ---------------------------------------------Anchor config
BASE_ANCHOR_SIZE_LIST = [128]  # can be modified
ANCHOR_STRIDE = [16]  # can not be modified in most situations
ANCHOR_SCALES =[0.1,1.,5.,10] #[0.5, 1., 2.0]  # [4, 8, 16, 32]
ANCHOR_RATIOS = [1/3, 0.5, 1., 2.,5.]
